...
public class GraphTestDriver {
     ...
     **/
    private final Map<String, Map<String, Map<String, String>>> graphs = new HashMap<String, Map<String, Map<String, String>>>();
    ...
    private void createGraph(String graphName) {
        graphs.put(graphName, new HashMap<String, Map<String, String>>());
    ...
    private void addNode(String graphName, String nodeName) {
        Map<String, Map<String, String>> nodes = graphs.get(graphName);
        Map<String, String> edges = new HashMap<String, String>();
        nodes.put(nodeName, edges);
    ...
    private void addEdge(String graphName, String parentName, String childName,
                         String edgeLabel) {
        Map<String, Map<String, String>> nodes = graphs.get(graphName);
        Map<String, String> edges = nodes.get(parentName);
        if (nodes.containsKey(childName) && edgeLabel != null && !edgeLabel.equals("null")) {
            edges.put(childName, edgeLabel);
